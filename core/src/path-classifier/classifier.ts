...
const CODE_SIGNALS = /```|function |class |import |SELECT |CREATE |INSERT |DELETE |UPDATE |export |const |async /

const RESEARCH_SIGNALS = /analisis|riset|bandingkan|tren|kompetitor|data|statistik|penelitian|survey|laporan|perbandingan|analysis|research|compare|trend|competitor|statistics|report/i

const TEMPORAL_SIGNALS = /hari ini|terbaru|sekarang|minggu ini|terkini|bulan ini|kemarin|recent|latest|current|today|this week|this month|yesterday/i
