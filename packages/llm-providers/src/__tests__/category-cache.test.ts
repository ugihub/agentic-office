...
describe('classifyCacheCategory', () => {
  it('classifies financial prompts correctly', () => {
    ...
    expect(classifyCacheCategory('what is the current stock price of AAPL')).toBe('financial')
  ...
  it('classifies temporal prompts', () => {
    expect(classifyCacheCategory('what happened today in tech')).toBe('temporal')
  ...
  it('classifies personnel prompts', () => {
    ...
    expect(classifyCacheCategory('siapa direktur utama Telkom')).toBe('personnel')
  })
  ...
  it('defaults non-matching prompts', () => {
    expect(classifyCacheCategory('explain how neural networks work')).toBe('default')
