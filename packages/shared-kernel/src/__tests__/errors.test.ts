...
describe('Error hierarchy', () => {
  ...
  describe('LlmProviderError', () => {
    it('carries provider context', () => {
      const e = new LlmProviderError('anthropic', 'claude-sonnet-4-6', '503 Service Unavailable')
    ...
    it('supports cause chaining', () => {
      ...
      const e = new LlmProviderError('anthropic', 'claude-sonnet-4-6', 'failed', { cause })
  ...
  describe('isBureauError()', () => {
    it('returns true for BureauError subclasses', () => {
      ...
      expect(isBureauError(new ValidationError('field', 'required'))).toBe(true)
    })
