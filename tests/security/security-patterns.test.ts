...
import { signJwt, verifyJwt, initJwtKeys } from '../../packages/auth/src/jwt.js'
...
describe('Security: JWT RS256', () => {
  ...
  it('verifyJwt rejects expired token', async () => {
    ...
    const expiredToken = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyXzEyMyIsImlhdCI6MTYxNjIzOTAyMiwiZXhwIjoxNjE2MjM5MDIyfQ.INVALID_SIGNATURE'
...
describe('Security: Tenant Isolation', () => {
  it('tenantId required in all data queries', () => {
    ...
    const repositoryPattern = {
      ...
      updateOne: (filter: object, update: object, tenantId: string) => ({ filter, update, tenantId }),
    }
